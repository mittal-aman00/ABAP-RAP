 ...
 CLASS ltcl_integration_test DEFINITION FINAL FOR TESTING
    ...
    CLASS ltcl_integration_test IMPLEMENTATION.
     ...
     METHOD create_travel.
      ...
      DATA travels_in TYPE TABLE FOR CREATE zi966U_rap_travel_1\\travel.   "Use Behavior Definition
      ...
      MODIFY ENTITIES OF zi966U_rap_travel_1    "Use Behavior Definition
        ENTITY travel
      ...
      "Using the assert statements we are checking that the return structures
      "failed and reported, that would indicate an error, are empty. If this is true,
      "we commit the data
      ...
      SELECT * FROM zi966u_rap_travel_1 WHERE TravelId = @new_travel_id INTO TABLE @DATA(lt_travel)  .
    ...
    METHOD class_setup.
      cds_test_environment = cl_cds_test_environment=>create_for_multiple_cds(
          i_for_entities = VALUE #( ( i_for_entity = 'zi966u_rap_travel_1' )
                                  ( i_for_entity = 'zi966u_rap_booking_2' ) )
                                ).
    ENDMETHOD.
