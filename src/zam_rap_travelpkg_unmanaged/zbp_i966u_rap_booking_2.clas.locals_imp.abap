CLASS lhc_Booking DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
    ...
    "Update method if a booking entity is going to be updated, from the signature.
    METHODS update FOR MODIFY
      IMPORTING entities FOR UPDATE Booking.

    "Delete method that will be called when deleting a booking entity
...
CLASS lhc_Booking IMPLEMENTATION.
  ...
  METHOD update.
    ...
    LOOP AT entities ASSIGNING FIELD-SYMBOL(<entity>).
      ...
      legacy_entity_x-_intx      = CORRESPONDING zs966_rap_booking_2( <entity> MAPPING FROM ENTITY ).
  ...
  "The delete methods get a list of keys travelid and bookingid of the booking entities
  "that shall be deleted. To delete booking entities using the legacy API we will use the
  "function module /DMO/FLIGHT_TRAVEL_UPDATE
  METHOD delete.
  ...
  "The read method gets a list of keys of booking entities whose data should be read.
  "The legacy API, the funcion module /DMO/FLIGHT_TRAVEL_READ always reads all bookings
  "for a TravelID. In order to avoid to call the legacy API, several times we are grouping
  "the incoming keys by TravelID.
  METHOD read.
  ...
  "This method reads the details of a parent travel entity when a booking entity
  "is updated because we have defined in the behavior definition that the etag
  "for the booking entity does depend on the etag of the parent entity Travel.
  METHOD rba_Travel.
